...
od <- read.csv("OD_maps/pred_downscale_with_ci_V3.csv")
...
sf::st_write(
  obj = map,
  dsn = "OD_maps/base_map.gpkg",     # or .shp if you prefer
  driver = "GPKG",                   # use "ESRI Shapefile" for .shp
  append = FALSE
)
...
print(world_plot)
ggsave("OD_maps/OD_region_world_map.png", world_plot,
