#' ---
#' title: "00_FUN_Calculate_incidence_desired_use_case"
#' author: "K Joshi"
#' 
#' ---
#' 
...
calculate_incidence_desired_use_case <- function(x, 
  ...
  adm0_data_incidence <- adm0_data_population %>%
    ungroup() %>%
    mutate(Actual_seasonal_total_cases_per_100000_pop = round((Total_season_cases/Population_interpolated)*100000),
           Predicted_seasonal_total_cases_per_100000_pop = round((Predicted_seasonal_cases/Population_interpolated)*100000),)
