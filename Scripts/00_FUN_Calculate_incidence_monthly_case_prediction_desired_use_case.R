#' ---
#' title: "00_FUN_Calculate_incidence_monthly_case_prediction_desired_use_case"
#' author: "K Joshi"
#' 
#' ---
#' 
...
Calculate_incidence_monthly_case_prediction_desired_use_case <- function(x, 
  ...
  adm0_data_incidence <- adm0_data_population %>%
    ungroup() %>%
    mutate(Actual_monthly_cases_per_100000_pop = round((Actual_monthly_cases/Population_interpolated)*100000),
           Predicted_monthly_cases_per_100000_pop = round((Predicted_monthly_cases/Population_interpolated)*100000),)
