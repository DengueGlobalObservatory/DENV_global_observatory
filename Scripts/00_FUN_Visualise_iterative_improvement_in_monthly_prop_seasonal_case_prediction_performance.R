#' ---
#' title: "00_FUN_Visualise_iterative_improvement_in_monthly_prop_seasonal_case_prediction_performance"
#' author: "K Joshi"
#' 
#' ---
#' 
...
Visualise_iterative_improvement_in_monthly_prop_seasonal_case_prediction_performance <- function(x){
  ...
  #--------------- Improvement in prediction of total seasonal cases with each month of new data - data prep
  
  #' Calculate the rmse of months where 75% --> 90% of cases have occurred. Use this RMSE to calculate a RMSE ratio. 
  
  x_iterative_improvement_total_seasonal_cases_pred <- x %>% 
    ...
    mutate(Acc_vs_pred_total_rmse = rmse(Total_season_cases, Predicted_seasonal_cases)) %>% 
    select(Country, iso3, season_nMonth, Acc_vs_pred_total_rmse, 
    ...
    group_by(Country) %>% 
    mutate(
      RMSE_at_75 = Acc_vs_pred_total_rmse[which(season_nMonth == Ave_Month_cutoff_above_0.75_of_total_cases)[1]],
      RMSE_at_80 = Acc_vs_pred_total_rmse[which(season_nMonth == Ave_Month_cutoff_above_0.8_of_total_cases)[1]],
      RMSE_at_85 = Acc_vs_pred_total_rmse[which(season_nMonth == Ave_Month_cutoff_above_0.85_of_total_cases)[1]],
      RMSE_at_90 = Acc_vs_pred_total_rmse[which(season_nMonth == Ave_Month_cutoff_above_0.9_of_total_cases)[1]]) %>% # Identify RMSE value at cutoff month 
    ungroup() %>% 
    mutate(Total_RMSE_to_0.75_prop_rmse = Acc_vs_pred_total_rmse / RMSE_at_75,
  ...
  x_iterative_improvement_total_seasonal_cases_pred_0.8_ordered <- x_iterative_improvement_total_seasonal_cases_pred %>% 
    mutate(Country = fct_reorder(Country, Total_RMSE_to_0.8_prop_rmse, .fun = mean, .desc = FALSE, .na_rm = FALSE)) 
  
  x_iterative_improvement_total_seasonal_cases_pred_0.85_ordered <- x_iterative_improvement_total_seasonal_cases_pred %>% 
    mutate(Country = fct_reorder(Country, Total_RMSE_to_0.85_prop_rmse, .fun = mean, .desc = FALSE, .na_rm = FALSE)) 
  
  x_iterative_improvement_total_seasonal_cases_pred_0.9_ordered <- x_iterative_improvement_total_seasonal_cases_pred %>% 
  ...
  iterative_improvement_total_seasonal_cases_pred_0.75_benchmark_scatterplot <- ggplot(x_iterative_improvement_total_seasonal_cases_pred_0.75_ordered) + 
  ...
  iterative_improvement_total_seasonal_cases_pred_0.8_benchmark_scatterplot <- ggplot(x_iterative_improvement_total_seasonal_cases_pred_0.8_ordered) + 
  ...
  iterative_improvement_total_seasonal_cases_pred_0.85_benchmark_scatterplot <- ggplot(x_iterative_improvement_total_seasonal_cases_pred_0.85_ordered) + 
  ...
  iterative_improvement_total_seasonal_cases_pred_0.9_benchmark_scatterplot <- ggplot(x_iterative_improvement_total_seasonal_cases_pred_0.9_ordered) + 
