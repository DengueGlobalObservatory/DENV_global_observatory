...
#' and 02_V2_PAHO_monthly_cases.R
#' 
...
log_message("Running 02_V2_source_selection.R")
...
current_data <- current_data %>%
  ...
  tidyr::complete(
    ...
    fill = list(cases = NA, source = NA, d = NA_real_, d_unit = NA_character_)  # Preserve delay fields for missing months
  ) %>%
  ungroup() %>%
